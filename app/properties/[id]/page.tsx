    ...
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex gap-6">
            ...
            <Link href="/properties" className="text-sm font-medium transition-colors text-primary">
              Properties
            </Link>
      ...
      <main className="flex-1">
        <div className="container py-6">
          <Link href="/properties" className="inline-flex items-center text-sm font-medium mb-6 hover:text-primary">
            ...
            <div className="lg:col-span-2">
              <div className="relative aspect-[4/3] overflow-hidden rounded-lg mb-6">
                <Image
                  ...
                  priority
                />
                <Badge className="absolute top-4 left-4 bg-primary">{property.propertyType}</Badge>
              </div>
              ...
              {[1, 2, 3].map((i) => (
                <Card key={i} className="overflow-hidden">
                  ...
                  <CardContent className="p-4">
                    <div className="space-y-2">
                      <h3 className="font-bold text-lg line-clamp-1">Luxury Family Home</h3>
                      <div className="flex items-center text-muted-foreground">
                        <MapPin className="h-4 w-4 mr-1 flex-shrink-0" />
                        <span className="text-sm line-clamp-1">456 Park Avenue, New York, NY</span>
                      </div>
                      <p className="text-xl font-bold text-primary">$1,850,000</p>
                    </div>
                    <div className="grid grid-cols-3 gap-2 mt-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-sm">3200 sqft</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
      ...
      <footer className="border-t bg-muted">
        <div className="container py-8 md:py-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-muted-foreground">123 Real Estate Blvd, Suite 100, New York, NY 10001</span>
                </li>
          ...
          <div className="border-t mt-8 pt-8 text-center text-muted-foreground">
            <p>© {new Date().getFullYear()} PrimeEstate. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
